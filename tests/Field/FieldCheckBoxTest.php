...
final class FieldCheckBoxTest extends TestCase
{
    ...
    public function testEnclosedByLabelWithLabelAttributes(): void
    {
        ...
        $this->assertEqualsWithoutLE(
            $expected,
            Field::widget()->checkbox(new TypeForm(), 'bool')->labelClass('test-class')->value(true)->render(),
        );
    }
    ...
    public function testEnclosedByLabelCustomText(): void
    {
        ...
        $this->assertEqualsWithoutLE(
            $expected,
            Field::widget()->checkbox(new TypeForm(), 'bool')->label('test-text-label')->value(true)->render(),
        );
    }
    ...
    public function testLabelClass(): void
    {
        ...
        $this->assertEqualsWithoutLE(
            $expected,
            Field::widget()->checkbox(new TypeForm(), 'int')->labelClass('test-class')->value(1)->render(),
        );
    }
